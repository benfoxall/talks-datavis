...
importScripts('sources/runkeeper/bower_components/cache-polyfill/index.js');

// storage
importScripts('sources/runkeeper/bower_components/dexie/dist/latest/Dexie.min.js');
importScripts('sources/runkeeper/db.js');

// api retrieval
importScripts('sources/runkeeper/bower_components/async/dist/async.min.js');

// geojson helpers
importScripts('sources/runkeeper/geofn.js');
importScripts('sources/runkeeper/simplify-geojson.bundle.js');
